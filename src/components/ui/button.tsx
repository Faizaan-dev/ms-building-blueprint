  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        // Premium variants for MS Building
        accent: "bg-accent text-accent-foreground hover:shadow-accent-glow hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-accent text-accent-foreground shadow-accent-glow hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] font-semibold",
        ...
        "nav-cta": "bg-accent text-accent-foreground hover:shadow-accent-glow rounded-full px-6",
        premium: "bg-gradient-to-r from-accent to-gold-light text-accent-foreground shadow-lg hover:shadow-accent-glow hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
